...
#define FW_COM_BUFFER_MAX_SIZE               1024   //!< Max size of Fw::Com buffer
#endif
...
#define FW_CMD_STRING_MAX_SIZE           130   //!< Max character size of command string arguments
#endif
...
#define FW_LOG_STRING_MAX_SIZE           130   //!< Max size of log string parameter type
#endif
...
#define FW_FILE_BUFFER_MAX_SIZE             2048   //!< Max size of file buffer (i.e. chunk of file)
#endif
